...
import Task16_Gerasimik_Pavel.SQLRequests.CreateTables;
import Task16_Gerasimik_Pavel.SQLRequests.GetInformation;
...
public class Main {
    public static void main(String[] args) throws SQLException, ClassNotFoundException, EntityDoNotExistException {
        ...
        try {
            ...
            GetInformation.selectPersonPetData().forEach(System.out::println);
